...
?>
    <div class="container col-9 rounded-0">
        <div class="col-12 rounded p-4 mt-4 d-flex gap-5">
            <div class="col-4 d-flex justify-content-end align-items-start"><img src="assets/img/profile/<?=$profile[0]['profile_pic']?>"
                    class="img-thumbnail rounded-circle my-3" style="height:170px;" alt="...">
            </div>
            <div class="col-8">
                <div class="d-flex flex-column">
                    <div class="d-flex gap-5 align-items-center">
                        <span style="font-size: xx-large;"><?=$profile[0]['firstname'].' '.$profile[0]['lastname']?></span>
                        <div class="dropdown">
                    ...
                    <span style="font-size: larger;" class="text-secondary">@<?=$profile[0]['username']?></span>
        ...
        <div class="gallery d-flex flex-wrap justify-content-center gap-2 mb-4">
            <?php
            foreach($posted_img as $all_img){
            ?>
            <img src="assets/img/posts/<?=$all_img['post_img']?>" width="300px" class="rounded" />
            <?php
            }
            ?>
